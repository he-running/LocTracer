...
import com.siho.loctracer.clusterutil.projection.Bounds;
...
import com.siho.loctracer.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    /**
     * Any modifications should be synchronized on mQuadTree.R
     */
